...
class GitHubAutomation:
    def __init__(self, repo_path=None):
        if repo_path:
            ...
            if (current_dir / ".git").exists():
                ...
                self.repo_path = current_dir.parent
                print("📁 Git repository found in parent directory")
            else:
                self.repo_path = current_dir
    ...
    def export_stats(self):
        ...
        try:
            # Find the astrology_ai directory
            if self.repo_path.name == "astrology_ai":
                astrology_dir = self.repo_path
            else:
